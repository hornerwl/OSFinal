...
int main()
{
  ...
  cout << "rv from openFile is /e/a/a/b " << f3 <<(f3==-1 ? " correct": " fail") <<endl;
  ...
  cout << "rv from createDirectory /e/g/a is " << r <<(r==0 ? " correct": " fail") <<endl;
  r = c1->myFS->createDirectory(const_cast<char *>("/g/a/g"), 6);
  cout << "rv from createDirectory /e/g/a is " << r <<(r==0 ? " correct": " fail") <<endl;
  r = c1->myFS->createFile(const_cast<char *>("/g/a/g/x"), 8);
  cout << "rv from createFile /e/g/a/x is " << r <<(r==0 ? " correct": " fail") <<endl;
